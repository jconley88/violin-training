var Tuner, frequencies, root, setIntervalId, success,
...
success = function(callback, stream) {
  var audioContext, buffer, bufferFillSize, bufferFiller, error, fft, fftSize, gauss, hp, i, lp, sampleRate;
...
//              display.clear();
  ...
  Tuner = function(callback) {
    ...
    return navigator.getUserMedia({
      audio: true
    }, _.partial(success, callback), error);
  };
